...
#	for anole genome relative expression with minimum FPKM of 0.25.
#
#	Required Programs:	R
#				              Boot
#############################################################
...
#--------------------------
# 1. Remove genes with an FPKM below 0.25 for either male or female expression
#--------------------------
...
# Autosomes
mf<-read.csv("MF_GeneExp0.25FPKM.csv",header=TRUE)
...
chrx<-read.csv("PropX0.25FPKM.csv",header=TRUE)
